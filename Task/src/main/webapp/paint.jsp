...
::-webkit-scrollbar-thumb {
  ...
  <p
     ...
     <div id="logout-container"  style="display: none">
      ...
      <!-------------------------------------Paint section---------------------->
    <div class="container  flex gap-2.5 px-2.5  w-[82%] ">
      <section class="tools-board border-4 border-[#DCBFFF] drop-shadow-2xl bg-white h-[60%] rounded-md w-52 p-4 mt-2.5">
        <div class="row mb-5">
      ...
      <section class="drawing-board drop-shadow-2xl flex-1 overflow-hidden p-2.5">
        <canvas class=" border-4 border-[#DCBFFF]  w-full h-full"></canvas>
      </section>
    </div>
