			...
			<div class="flex flex-col justify-between flex-1 mt-6">
				<nav class="cursor-pointer">
					...
					<p
						...
						<a
							href="/Task/schedule.jsp?username=<%=username%>&email=<%=emailid%>"
					...
					<p
						...
						<a
							href="/Task/paint.jsp?username=<%=username%>&email=<%=emailid%>"
					...
					<p
						...
						<a
							href="/Task/files.jsp?username=<%=username%>&email=<%=emailid%>"
					...
					<p
						...
						<a
							href="/Task/editor.jsp?username=<%=username%>&email=<%=emailid%>"
