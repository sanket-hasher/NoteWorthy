        ...
        <div class="swiper-button-prev"></div>
          ...
          <form id="reviewForm" onsubmit="submitReview(event)">
            ...
            <div>
              ...
              <input type="text" id="Name" name="Name" class="mt-1 p-2 w-full border rounded-md bg-white focus:bg-white focus:border-2 focus:border-gray-900  focus:outline-0"
                required />
            </div>
