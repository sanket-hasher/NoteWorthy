<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <html>
      ...
      <body class="bg-white text-black" >
        ...
        <div class="flex flex-col items-center w-full mb-8 p-8 bg-[#CDC1FF]">
          <h2 class="text-center text-4xl font-bold mb-8">Services</h2>
          <div class="grid grid-cols-4 text-start gap-16">
            <div
              class="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-[20rem]"
            >
              <div class="p-4">
        ...
        <div class="w-screen max-w-[90%] m-auto mb-8">
          ...
          <div class="flex flex-col w-[40%]">
            <div>
              ...
              <div>
                <p class="text-2xl">⭐⭐⭐⭐⭐</p>
                <h2 class=" text-3xl font-bold">Emily R</h2>
                <p>"I absolutely love this study planner! It helps me stay organized and 
                  on track with my work. The automatic syncing between my laptop 
                  and phone is a game-changer!"
                  </p>
                </div>
